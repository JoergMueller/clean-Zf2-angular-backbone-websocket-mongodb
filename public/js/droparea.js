	...
	var m = {
		...
		upload: function(file, input, area){
			...
			xhr.addEventListener("load", function (e) {
				var result = jQuery.trim(e.target.responseText);
			...
			xhr.setRequestHeader("X-File-Name", file.fileName == undefined ? file.name : file.fileName);
			xhr.setRequestHeader("X-File-Size", file.fileSize == undefined ? file.size : file.fileSize);
